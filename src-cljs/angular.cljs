...
(def.config kipsufi [$routeProvider]
            (-> $routeProvider
              ...
              (.when "/algorithms" (obj :controller "AlgorithmsController" :templateUrl "views/list.html"))
              (.when "/datastructures" (obj :controller "DatastructuresController" :templateUrl "views/list.html"))
